...
# Simply adjust the min_length parameter when calling unzip_and_process_genomes().
# For example, if you want to filter out ORFs shorter than 150 codons, 
# you would call the function like this: unzip_and_process_genomes(zip_file_path, output_fasta_file, min_length=150)

#To Run on BASH: 
#hernanym ➜ /workspaces/gene-finder.py-YHM- (main) $ python LengthFilter_ORF.py --min_length 150